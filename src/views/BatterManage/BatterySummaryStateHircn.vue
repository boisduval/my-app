...
export default {
  ...
  data () {
    return {
      ...
      series4: [],
      url: [
        '/api/Monitor/GetBatterySummaryStateHircn',
        '/api/Monitor/GetBatterySummaryStateMiroam',
        '/api/Monitor/GetBatterySummaryStateMircn',
        '/api/Monitor/GetBatterySummaryStateMiroamm'
      ]
    }
  },
  created () {
    this.getBatterySummaryStateHircn()
  },
  methods: {
    ...mapMutations('statedetail', ['set_paramsTvpbc']),
    getBatterySummaryStateHircn () {
      this.legend1 = []
      this.xAxis1 = []
      this.series1 = []
      this.$axios
        ...
        .then(res => {
          if (res.data.code === 0) {
            ...
            this.getBatterySummaryStateMiroam()
          }
        })
        .catch(err => {
          console.error(err)
      ...
      this.$axios
        ...
        .then(res => {
          if (res.data.code === 0) {
            ...
            this.getBatterySummaryStateMircn()
          }
        })
        .catch(err => {
          console.error(err)
      ...
      this.$axios
        ...
        .then(res => {
          if (res.data.code === 0) {
            ...
            this.getBatterySummaryStateMiroamm()
          }
        })
        .catch(err => {
          console.error(err)
