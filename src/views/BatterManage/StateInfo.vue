<template>
  <div>
      ...
      <div style="box-sizing:border-box;" v-show="isShow">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span>{{ $t("stateInfo.searchTitle") }}</span>
          </div>
          <el-form
            :inline="true"
            :model="formInline"
          ...
          >
            <el-form-item :label="$t('stateInfo.searchForm.label')[0]">
              <el-input
                v-model="formInline.ICCID"
                :placeholder="$t('stateInfo.searchForm.placeholder')[0]"
              ></el-input>
            </el-form-item>
            <el-form-item :label="$t('stateInfo.searchForm.label')[1]">
              <el-input
                v-model="formInline.IDS"
                :placeholder="$t('stateInfo.searchForm.placeholder')[1]"
              ></el-input>
            </el-form-item>
            <el-form-item :label="$t('stateInfo.searchForm.label')[2]">
              <el-input
                v-model="formInline.VIN"
                :placeholder="$t('stateInfo.searchForm.placeholder')[2]"
              ></el-input>
            </el-form-item>
            <el-form-item :label="$t('stateInfo.searchForm.label')[3]">
              <el-input
                v-model="formInline.Name"
                :placeholder="$t('stateInfo.searchForm.placeholder')[3]"
              ></el-input>
            </el-form-item>
            <!-- <br> -->
            <el-form-item>
    ...
    <el-card class="box-card visible">
      <div slot="header" class="clearfix">
        <span>{{ $t("stateInfo.listTitle") }}</span>
      </div>
      ...
      >
        ...
        <vxe-table-column
          type="seq"
          width="50"
          :title="$t('stateInfo.tableLabel')[0]"
          fixed="left"
          align="center"
        >
        </vxe-table-column>
        <vxe-table-column
          field="DICCID"
          :title="$t('stateInfo.tableLabel')[1]"
          sortable
          width="250"
          show-overflow
        ...
        <vxe-table-column
          field="DIDS"
          :title="$t('stateInfo.tableLabel')[2]"
          sortable
          width="250"
          show-overflow
          show-header-overflow
        ...
        <vxe-table-column
          field="DVIN"
          :title="$t('stateInfo.tableLabel')[3]"
          sortable
          width="250"
          show-overflow
          show-header-overflow
        ...
        <vxe-table-column
          field="DName"
          :title="$t('stateInfo.tableLabel')[4]"
          sortable
          width="150"
          show-overflow
          show-header-overflow
        ...
        <vxe-table-column
          ...
          :title="$t('stateInfo.tableLabel')[5]"
          sortable
          width="150"
          show-overflow
          show-header-overflow
        ...
        <vxe-table-column
          field="DTime"
          :title="$t('stateInfo.tableLabel')[6]"
          sortable
          width="180"
          align="center"
          show-overflow
        ...
        <vxe-table-column
          :title="$t('stateInfo.tableLabel')[7]"
          width="250"
          align="center"
          show-overflow
          show-header-overflow
...
export default {
  data () {
    return {
      ...
      detail: [
        {
          label: this.$t('stateInfo.detail')[0],
          path: '/batterySummary'
        },
        {
          label: this.$t('stateInfo.detail')[1],
          path: '/dataVisual'
        }
      ],
      exportConfig: {
