...
const mutations = {
  ...
  set_paramsSC (state, params) {
    state.paramsSC.AutoSystemID = params['AutoSystemID']
    state.paramsSC.SystemID = params['SystemID']
    state.paramsSC.batterID = params['batterID']
  },
